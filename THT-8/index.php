...
<body>
            ...
            <article>
                ...
                <div class="comment-bot-sec border-red">
                    ...
                    <div class="comment-slider">
                        <button onclick="prevComment()"><i class="fa-solid fa-arrow-left" style="color: #ffffff;"></i></button>
                        <button onclick="nextComment()"><i class="fa-solid fa-arrow-right" style="color: #ffffff;"></i></button>
                    </div>
                </div>
            </article>
            <aside class="border-green">
                <img id="customerImage" src="./assets/images/amanda-seyfried.jpg" alt="">
            </aside>
        </section>
    </main>
    <!-- footer -->
    ...
    <script>
        ...
        function displayComment() {
            ...
            personImage.src = `./assets/images/${comments[currentIndex].picture}`
        }
